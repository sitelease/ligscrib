...
export async function getArgs(argv = process.argv) : Promise<{ inputs: string[], outDir: string, name: string, prefix: string, verbose?: boolean, css: boolean, scss: boolean, yaml: boolean, example?: boolean, faIconClasses?: boolean, faUtilityClasses?: boolean, types: Set<string> }> {
    const args = await yargs
        ...
        .boolean('yaml')
        .describe('yaml', 'Create a icon-families YAML file (--no-yaml)')
        .default('yaml', true)
